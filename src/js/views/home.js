...
{/* <!-- Hero 2 - Bootstrap Brain Component --> */}
  ...
  <main id="main">
      ...
      <div className="container mb-5 mb-md-6 mb-xl-10">
        <div className="row justify-content-md-center">
          <div className="col-12 col-md-10 col-lg-9 col-xl-8 col-xxl-7 text-center">
            <h2 className="display-3 fw-bolder mb-4">You will get the perfect <mark className="wave-highlight wave-highlight-yellow"><span className="wave-font-hw display-1 text-accent fw-normal">resolutions</span></mark> with our proficient services.</h2>
          </div>
        </div>
      </div>
    ...
    {/* <!-- Section - About --> */}
    <section id="scrollspyAbout" className="wave-bg-alice-blue py-5 py-xl-8 py-xxl-16">
      {/* <!-- FAQ 1 - Bootstrap Brain Component --> */}
      <div className="container">
        <div className="row gy-5 gy-lg-0 gx-lg-6 gx-xxl-8 align-items-lg-center">
          <div className="col-12 col-lg-6">
            <img className="img-fluid rounded" loading="lazy" src="./assets/img/about/about-img-1.png" alt=""></img>
          </div>
          <div className="col-12 col-lg-6">
            <h2 className="display-3 fw-bolder mb-4">Our <mark className="wave-highlight wave-highlight-blue"><span className="wave-font-hw display-1 text-accent fw-normal">optimistic</span></mark><br></br> methods will let you prefer us.</h2>
      ...
      <div className="container pt-5 pt-xl-8 pt-xxl-16">
        <div className="row gy-4">
          <div className="col-12 col-sm-6 col-xl-3">
            <div className="card border-0 border-bottom border-primary shadow-sm">
              <div className="card-body text-center p-4 p-xxl-5">
                <div className="btn btn-primary btn-circle btn-circle-4xl wave-bg-yellow border-0 text-primary pe-none mb-2">
          ...
          <div className="col-12 col-sm-6 col-xl-3">
            <div className="card border-0 border-bottom border-primary shadow-sm">
              <div className="card-body text-center p-4 p-xxl-5">
                <div className="btn btn-primary btn-circle btn-circle-4xl wave-bg-green border-0 text-primary pe-none mb-2">
          ...
          <div className="col-12 col-sm-6 col-xl-3">
            <div className="card border-0 border-bottom border-primary shadow-sm">
              <div className="card-body text-center p-4 p-xxl-5">
                <div className="btn btn-primary btn-circle btn-circle-4xl wave-bg-pink border-0 text-primary pe-none mb-2">
          ...
          <div className="col-12 col-sm-6 col-xl-3">
            <div className="card border-0 border-bottom border-primary shadow-sm">
              <div className="card-body text-center p-4 p-xxl-5">
                <div className="btn btn-primary btn-circle btn-circle-4xl wave-bg-cyan border-0 text-primary pe-none mb-2">
    ...
    <section id="scrollspyTeam" className="py-5 py-xl-8 py-xxl-16">
      <div className="container mb-5 mb-md-6 mb-xl-10">
        <div className="row justify-content-md-center">
          <div className="col-12 col-md-10 col-lg-9 col-xl-8 col-xxl-7 text-center">
            <h2 className="display-3 fw-bolder mb-4">We are a group of <br></br><mark className="wave-highlight wave-highlight-yellow"><span className="wave-font-hw display-1 text-accent fw-normal">innovative</span></mark>, experienced, and proficient teams.</h2>
          </div>
        </div>
      </div>
        ...
        <div className="row gy-4 gy-lg-0 gx-xxl-5">
            ...
            <div className="card border-0 border-bottom border-primary shadow-sm overflow-hidden">
              <div className="card-body p-0">
                <figure className="m-0 p-0">
                  <img className="img-fluid" loading="lazy" src="./assets/img/team/team-img-1.jpg" alt=""></img>
          ...
          <div className="col-12 col-md-6 col-lg-3">
            <div className="card border-0 border-bottom border-primary shadow-sm overflow-hidden">
              <div className="card-body p-0">
                <figure className="m-0 p-0">
                  <img className="img-fluid" loading="lazy" src="./assets/img/team/team-img-2.jpg" alt=""></img>
                  <figcaption className="m-0 p-4">
          ...
          <div className="col-12 col-md-6 col-lg-3">
            <div className="card border-0 border-bottom border-primary shadow-sm overflow-hidden">
              <div className="card-body p-0">
                <figure className="m-0 p-0">
                  <img className="img-fluid" loading="lazy" src="./assets/img/team/team-img-3.jpg" alt=""></img>
                  <figcaption className="m-0 p-4">
          ...
          <div className="col-12 col-md-6 col-lg-3">
            <div className="card border-0 border-bottom border-primary shadow-sm overflow-hidden">
              <div className="card-body p-0">
                <figure className="m-0 p-0">
                  <img className="img-fluid" loading="lazy" src="./assets/img/team/team-img-4.jpg" alt=""></img>
                  <figcaption className="m-0 p-4">
    ...
    <section id="scrollspyPricing" className="wave-bg-sea-shell py-5 py-xl-8 py-xxl-16">
      <div className="container">
        <div className="row gy-5 gy-lg-0 gx-lg-8 align-items-center">
          <div className="col-12 col-lg-5">
            <h2 className="display-3 fw-bolder mb-4">Our <mark className="wave-highlight wave-highlight-yellow"><span className="wave-font-hw display-1 text-accent fw-normal">Pricing</span></mark></h2>
            <p className="fs-4 mb-4 mb-xl-5">Explore our flexible pricing to find an excellent fit to run your business.</p>
            <a href="#!" className="btn btn-2xl btn-primary rounded-pill">More Plans</a>
          </div>
              ...
              <div className="col-12 col-md-6">
                <div className="card border-0 border-bottom border-primary shadow-sm">
                  <div className="card-body p-4 p-xxl-5">
                    ...
                    <a href="#!" className="btn btn-xl btn-accent rounded-pill">Choose Plan</a>
                  </div>
                </div>
              </div>
              <div className="col-12 col-md-6">
                <div className="card border-0 border-bottom border-primary shadow-lg pt-md-4 pb-md-4 mt-md-n4">
                  <div className="card-body p-4 p-xxl-5">
    ...
    <section className="py-5 py-xl-8 py-xxl-16">
      <div className="container mb-5 mb-md-6 mb-xl-10">
        <div className="row justify-content-md-center">
          <div className="col-12 col-md-10 col-lg-9 col-xl-8 col-xxl-7 text-center">
            <h2 className="display-3 fw-bolder mb-4">We believe in client <br></br><mark className="wave-highlight wave-highlight-yellow"><span className="wave-font-hw display-1 text-accent fw-normal">satisfaction</span></mark>. Here are some testimonials by our worthy clients.</h2>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <div className="row gy-4">
          <div className="col-12 col-lg-4">
            <div className="card border-0 border-bottom border-primary shadow-sm wave-bg-lotion">
              <div className="card-body p-4 p-xxl-5">
                <figure>
                  <img className="img-fluid rounded rounded-circle mb-4 border border-5" loading="lazy" src="./assets/img/testimonial/testimonial-img-1.jpg" alt=""></img>
                  <figcaption>
                    ...
                    <p className="fs-6 text-secondary mb-0">UX Designer</p>
                  </figcaption>
                </figure>
              </div>
            </div>
          ...
          <div className="col-12 col-lg-4">
            <div className="card border-0 border-bottom border-primary shadow-sm wave-bg-lotion">
              <div className="card-body p-4 p-xxl-5">
                <figure>
                  <img className="img-fluid rounded rounded-circle mb-4 border border-5" loading="lazy" src="./assets/img/testimonial/testimonial-img-2.jpg" alt=""></img>
                  <figcaption>
                    <blockquote className="bsb-blockquote-icon mb-4">Nam ultricies, ex lacinia dapibus faucibus, sapien ipsum euismod massa, at aliquet erat turpis quis diam. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</blockquote>
                    <h4 className="mb-2">Mark Smith</h4>
                    <p className="fs-6 text-secondary mb-0">Marketing Specialist</p>
                  </figcaption>
                </figure>
              </div>
            </div>
          ...
          <div className="col-12 col-lg-4">
            <div className="card border-0 border-bottom border-primary shadow-sm wave-bg-lotion">
              <div className="card-body p-4 p-xxl-5">
                <figure>
                  <img className="img-fluid rounded rounded-circle mb-4 border border-5" loading="lazy" src="./assets/img/testimonial/testimonial-img-4.jpg" alt=""></img>
                  <figcaption>
                    <blockquote className="bsb-blockquote-icon mb-4">Nam ultricies, ex lacinia dapibus faucibus, sapien ipsum euismod massa, at aliquet erat turpis quis diam. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.</blockquote>
                    <h4 className="mb-2">Luke Reeves</h4>
                    <p className="fs-6 text-secondary mb-0">Sales Manager</p>
                  </figcaption>
                </figure>
              </div>
            </div>
    ...
    {/* <!-- Section - Blog -->
    <!-- Pricing 1 - Bootstrap Brain Component --> */}
    <section id="scrollspyBlog" className="wave-bg-linen py-5 py-xl-8 py-xxl-16">
      <div className="container">
        <div className="row gy-5 gy-lg-0 gx-lg-8 align-items-center">
          <div className="col-12 col-lg-5">
            <h2 className="display-3 fw-bolder mb-4">Our <mark className="wave-highlight wave-highlight-yellow"><span className="wave-font-hw display-1 text-accent fw-normal">Blog</span></mark></h2>
            <p className="fs-4 mb-4 mb-xl-5">Stay tuned and updated by the latest updates from our blog.</p>
            <a href="#!" className="btn btn-2xl btn-primary rounded-pill">More News</a>
          </div>
          <div className="col-12 col-lg-7">
            <div className="row gy-4 gy-xxl-5 gx-xxl-5">
              <div className="col-12 col-lg-6">
                <article>
                  <figure className="rounded overflow-hidden mb-3 bsb-hover-overlay">
                    <a href="#!">
                      <img className="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="./assets/img/blog/blog-image-1.jpg" alt=""></img>
                    </a>
                    <figcaption>
                      ...
                      <h4 className="h6 text-white bsb-hover-fadeInLeft mt-2">Read More</h4>
                    </figcaption>
                  </figure>
                    ...
                    <div className="entry-meta">
                      <ul className="nav mb-2">
                        <li className="nav-item">
                          <a className="nav-link d-inline px-1 link-primary" href="#!">Business</a>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="entry-meta">
                      <ul className="nav mb-0 bsb-nav-sep">
                        <li className="nav-item text-secondary">
                          <a className="nav-link link-muted p-0 pe-3 d-inline-flex align-items-center" href="#!">
                            ...
                            <span className="ms-2 fs-7">7 Dec 2023</span>
                          </a>
                        </li>
                        <li className="nav-item text-secondary">
                          <a className="nav-link link-secondary p-0 ps-3 d-inline-flex align-items-center" href="#!">
              ...
              <div className="col-12 col-lg-6">
                <article>
                  <figure className="rounded overflow-hidden mb-3 bsb-hover-overlay">
                    <a href="#!">
                      <img className="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="./assets/img/blog/blog-image-2.jpg" alt=""></img>
                    </a>
                    <figcaption>
                  ...
                  <div className="entry-header mb-3">
                    <div className="entry-meta">
                      <ul className="nav mb-2">
                        <li className="nav-item">
                          <a className="nav-link d-inline px-1 link-primary" href="#!">Technology</a>
                        </li>
                      </ul>
                    </div>
                    <h2 className="entry-title h4 mb-0">
                      ...
                      <ul className="nav mb-0 bsb-nav-sep">
                        <li className="nav-item text-secondary">
                          <a className="nav-link link-secondary p-0 pe-3 d-inline-flex align-items-center" href="#!">
                            ...
                            <span className="ms-2 fs-7">12 Sep 2023</span>
                          </a>
                        </li>
                        <li className="nav-item text-secondary">
                          <a className="nav-link link-secondary p-0 ps-3 d-inline-flex align-items-center" href="#!">
              ...
              <div className="col-12 col-lg-6">
                <article>
                  <figure className="rounded overflow-hidden mb-3 bsb-hover-overlay">
                    <a href="#!">
                      <img className="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="./assets/img/blog/blog-image-3.jpg" alt=""></img>
                    </a>
                    <figcaption>
                      ...
                      <h4 className="h6 text-white bsb-hover-fadeInUp mt-2">Read More</h4>
                    </figcaption>
                  </figure>
                  <div className="entry-header mb-3">
                    <div className="entry-meta">
                      <ul className="nav mb-2">
                        <li className="nav-item">
                          <a className="nav-link d-inline px-1 link-primary" href="#!">Health</a>
                        </li>
                      </ul>
                    </div>
                    <h2 className="entry-title h4 mb-0">
                      ...
                      <ul className="nav mb-0 bsb-nav-sep">
                        <li className="nav-item text-secondary">
                          <a className="nav-link link-secondary p-0 pe-3 d-inline-flex align-items-center" href="#!">
                            ...
                            <span className="ms-2 fs-7">13 Jul 2023</span>
                          </a>
                        </li>
                        <li className="nav-item text-secondary">
                          <a className="nav-link link-secondary p-0 ps-3 d-inline-flex align-items-center" href="#!">
              ...
              <div className="col-12 col-lg-6">
                <article>
                  <figure className="rounded overflow-hidden mb-3 bsb-hover-overlay">
                    <a href="#!">
                      <img className="img-fluid bsb-scale bsb-hover-scale-up" loading="lazy" src="./assets/img/blog/blog-image-4.jpg" alt=""></img>
                    </a>
                    <figcaption>
                      <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-eye text-white bsb-hover-fadeInUp" viewBox="0 0 16 16">
                        <path d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8zM1.173 8a13.133 13.133 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5c2.12 0 3.879 1.168 5.168 2.457A13.133 13.133 0 0 1 14.828 8c-.058.087-.122.183-.195.288-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5c-2.12 0-3.879-1.168-5.168-2.457A13.134 13.134 0 0 1 1.172 8z" />
                        <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0z" />
                      </svg>
                      <h4 className="h6 text-white bsb-hover-fadeInDown mt-2">Read More</h4>
                    </figcaption>
                  </figure>
                  <div className="entry-header mb-3">
                    <div className="entry-meta">
                      <ul className="nav mb-2">
                        <li className="nav-item">
                          <a className="nav-link d-inline px-1 link-primary" href="#!">Networking</a>
                        </li>
                      </ul>
                    </div>
                    <h2 className="entry-title h4 mb-0">
    ...
    <section id="scrollspyContact" className="py-5 py-xl-8 py-xxl-16">
      <div className="container">
        <div className="row gy-5 gy-lg-0 gx-lg-6 gx-xxl-8 align-items-lg-center">
          <div className="col-12 col-lg-6">
            <img className="img-fluid rounded" loading="lazy" src="./assets/img/contact/contact-img-1.jpg" alt=""></img>
          </div>
          <div className="col-12 col-lg-6">
